...
<head>
    <?php includeTemplate('layout/header.php', ['title' => 'Ace']); ?>
</head>

<body style="background-image: url('/img/csgoace.jpg'); background-repeat: no-repeat; background-position: top;">
    ...
    <div class="container">
        ...
        <p><b>Format<br>
                Map pool: Mirage, Cache, Overpass, Dust 2, Train, Nuke
                <p>
                    Max Rounds: 30</p>
                Overtime: MR6, 10000$
            </b>
    ...
    <div class="page-wrapper chiller-theme toggled" style="margin-top: -1730px">
        <a id="show-sidebar" class="btn btn-sm btn-dark" href="Ace.html#">
