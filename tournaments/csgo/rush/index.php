...
<head>
    <?php includeTemplate('layout/header.php', ['title' => 'Rush']); ?>
</head>

<body style="background-image: url('/img/csgorush.jpg'); background-repeat: no-repeat; background-position: top;">
    ...
    <div class="container" style="margin-top: 220px">
        ...
        <p>All kind of cheating will result in a permanent suspension from Cyber Pro.</p>
        <p>Playing with a cheater will result in a 3 month suspension from Cyber Pro.</p>
        ...
        <p><b>
                All kind of cheating will result in a disqualification for the team.</p>
        <p>Toxic behavior will cause warnings and in severe cases both disqualifications and bans.</p>
        <p>Easy Esports Anti Cheat is required</p>
    ...
    <div class="page-wrapper chiller-theme toggled" style="margin-top: -1730px">
        <a id="show-sidebar" class="btn btn-sm btn-dark" href="Rush#">
