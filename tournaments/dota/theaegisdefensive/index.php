...
<head>
    <?php includeTemplate('layout/header.php', ['title' => 'The aegis defensive']); ?>
</head>

<body style="background-image: url('/img//aegiscup.jpg'); background-repeat: no-repeat; background-position: top;">
    ...
    <div class="container">
        ...
        <h1 class="mt-4 mb-3">The Aegis Defensive
        </h1>
        ...
        <h3>
            <center>Check-in Period</center>
        </h3>
        </p><br>
        <script src="https://megatimer.ru/get/34b28eb5622bf3b8b662cb649ad2658b.js"></script><br>
        ...
        <p><b>The Aegis Defensive on FSL Season!<br>
        ...
        <p>
        <h3>Hosted by OMEN by HP</h3>
        </p>

        <p><b>A new era of athletes deserves a new level of equipment.</p>
        <p>Get the performance competition demands with professional-grade accessories, innovative new form factors,
            and cutting-edge hardware that understands your climb to the top relies on power that won’t hold you
            back.</p>
    ...
    <div class="page-wrapper chiller-theme toggled" style="margin-top: -1730px">
        <a id="show-sidebar" class="btn btn-sm btn-dark" href="TheAegisDefensive#">
